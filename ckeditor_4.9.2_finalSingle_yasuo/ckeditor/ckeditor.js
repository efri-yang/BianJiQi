        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                domReady: function() {
                    ...
                    var c = [];
                    return function(b) {
                        function d() { try { document.documentElement.doScroll("left") } catch (e) { setTimeout(d, 1); return } a() } c.push(b);
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function(a, e) {
                ...
                if (!b) { var d = /\n{2}/g; if (d.test(c)) var m = "\x3c" + g + "\x3e",
                        p = "\x3c/" + g + "\x3e",
                        c = m + c.replace(d, function() { return p + m }) + p } c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            getCookie: function(a) { a = a.toLowerCase(); for (var e = document.cookie.split(";"), b, c, g = 0; g < e.length; g++)
                    if (b = e[g].split("\x3d"), c = decodeURIComponent(CKEDITOR.tools.trim(b[0]).toLowerCase()), c === a) return decodeURIComponent(1 < b.length ? b[1] : ""); return null },
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            ...
            function p() { var a, b, c, e = Math.min(O.length, n.length); for (a = 0; a < e; a++)
                    if (b = O[a], c = n[a], !b.equals(c)) return a; return a - 1 }
            ...
            if (l && F.type == CKEDITOR.NODE_TEXT && (q.equals(F) || q.type === CKEDITOR.NODE_ELEMENT && q.getFirst().equals(F))) c.append(a.document.createText(F.substring(L, C)));
                ...
                for (var O = q.getParents(), n = F.getParents(), N = p(),
                    ...
                    V = X.getNext(); for (Q != v || X.equals(n[Q]) && v < B ? b && (I = G.append(X.clone(0, f))) : M ? h(X, G, !1, E) : H && G.append(a.document.createText(X.substring(L))); V;) { if (V.equals(n[Q])) { da = Q; break } V = h(V, G) } G = I } G = c;
                for (Q = N; Q <= B; Q++)
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
                            ...
                            l.evaluator = function(a) { return !v(a) && !B(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone();
                        l.collapse();
                ...
                for (this._.nextNode = null; p;) {
                    ...
                    if (K) p.type == CKEDITOR.NODE_TEXT && f.test(p.getText()) && (K = 0);
                        ...
                        if (CKEDITOR.dtd.$block[q] && "false" == p.getAttribute("contenteditable")) { d = p;
                            b(this, a, d); break } else if (p.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) { if ("br" == q) K = 1;
                                ...
                                y = p.equals(x); break } k && (k.setEndAt(p, CKEDITOR.POSITION_BEFORE_START), "br" != q && (this._.nextNode = p));
                            J = 1 } else { if (p.getFirst()) { k || (k = this.range.clone(), k.setStartAt(p, CKEDITOR.POSITION_BEFORE_START));
                                p = p.getFirst(); continue } K = 1 }
                    }
                    ...
                    if (k && !J)
                        for (; !p.getNext(g) && !y;) { q = p.getParent(); if (q.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) { J = 1;
                                K = 0;
                                y || q.equals(x);
                                k.setEndAt(q, CKEDITOR.POSITION_BEFORE_END); break } p = q;
                            K = 1;
                            y = p.equals(x);
                            l = 1 } K && k.setEndAt(p, CKEDITOR.POSITION_AFTER_END);
    ...
    (function() {
        function a(a, b, c, d, f) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (p in O) { n = O[p];
                    ...
                    q = t;
                    q.length && (l[n] = q, h = !1) } l.nothingRequired = h;
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (f = 0; f < b.length; ++f) v = this.allow(b[f], c, d); return v } a(this, b, c, this.allowedContent, this._.allowedRules);
                return !0
            },
                ...
                CKEDITOR.scriptLoader.load(e, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++)
                        for (var l = 0; l < d.length; l++) { var n = d[l];
                            0 === e && f[l] && n.lang && n.langEntries && (a.lang[n.name] = n.langEntries[f[l]]); if (n[c[e]]) n[c[e]](a) } a.fireOnce("pluginsLoaded");
                    ...
                    if (k) k.push(c[0]);
                            ...
                            c = !!c[5]; if (r)
                                for (; m = a.exec(r);) { var e = m[1].toLowerCase();
                                    m = m[2] || m[3] || m[4] || "";
                                    g[e] = !m && d[e] ? e : CKEDITOR.tools.htmlDecodeAttr(m) } this.onTagOpen(f, g, c);!k && CKEDITOR.dtd.$cdata[f] && (k = []) } } else if (f = c[2]) this.onComment(f)
                }
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (m in k) {
                    ...
                    else { delete k[m]; break } r && (!1 === (g = a.onAttribute(b, d, r, g)) ? delete k[r] :
                        k[r] = g)
                }
            ...
            proto: {
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
                                    ...
                                    for (; t = d.getItem(f++);)
                                        if (!z(t)) { d = !0; break a }
                                d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), y(a.startContainer) && a.startContainer.appendBogus();
                ...
                if (!v.checkReadOnly()) {
                    ...
                    if (m = N) {
                        ...
                        if ("text" == w.type && w.inlineStylesRoot) { r = w.inlineStylesPeak;
                            ...
                            N = n.getOuterHtml().split("{cke-peak}").join(N) } r =
                            w.blockLimit.getName();
                        if (/^\s+|\s+$/.test(N) && "span" in CKEDITOR.dtd[r]) { var x = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            N = x + N + x } N = w.editor.dataProcessor.toHtml(N, { context: null, fixForBody: !1, protectedWhitespaces: !!x, dontFilter: w.dontFilter, filter: w.editor.activeFilter, enterMode: w.editor.activeEnterMode });
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({
                        ...
                        t = function(a) { return !a.equals(w) } } t || (t = function(a) { return !a.equals(e.block) && !a.equals(e.blockLimit) });
            ...
            return {
                list: {
                    ...
                    merge: function(a, c) { if (a.mergeListBookmark) { var d = a.mergeListBookmark.startNode,
                                ...
                                g.equals(h) || (h.moveChildren(g), h.remove()) } a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem), w = w.contains(CKEDITOR.dtd.$listItem), f.equals(w) || b(w, d, e));
                            d.remove();
                            e.remove() } }
                },
                block: {
                    ...
                    if ("BackCompat" != e.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat ||
                            ...
                            t.on("mousedown", function(a) {
                                function b(a) { a = a.data.$; if (q) { var c = l.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) {} q.setEndPoint(0 > u.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        q.select() } }
    ...
    (function() {
                    ...
                    if (q.equals(y)) q = null, l = !0;
                        ...
                        if (x && m && CKEDITOR.dtd.$block[z])
                            for (var E = q, C = f(E), F = void 0, H = C.length, K = 0, E = H && new CKEDITOR.dom.range(E.getDocument()); K < H; ++K) { var F = C[K],
                                    L = CKEDITOR.filter.instances[F.data("cke-filter")]; if (L ? L.check(this) : 1) E.selectNodeContents(F), b.call(this, E) } C = z ? !p[z] || A ? 0 : x && !m ? 0 : d(q, y, h, P) : 1;
                        if (C)
        ...
        function c(a) {
            function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(p.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break;
                    ...
                    r.checkElementRemovable(h, !0) && (f = h) } f && p.breakParent(f);
            ...
            if (a.collapsed) {
                ...
                if (g) {
                    ...
                    r = this;
                b(); for (f = d; !f.equals(p);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : x(f, l(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g } a.moveToBookmark(c);
        ...
        CKEDITOR.style.getStyleText = function(a) { var b = a._ST; if (b) return b; var b = a.styles,
            ...
            c.length && (c = c.replace(t, ";")); for (var e in b) { var f = b[e],
                    g = (e + ":" + f).replace(t, ";"); "inherit" == f ? d += g : c += g } c.length && (c = CKEDITOR.tools.normalizeCssText(c, !0)); return a._ST = c + d };
    ...
    */
    ...
    CKEDITOR.plugins.add("colorbutton", {
        ...
        init: function(d) {
            function t(a, e, g, r, l) {
                ...
                d.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    onBlock: function(a,
                        ...
                        CKEDITOR.ui.fire("ready", this); var c = b.keys,
                            f = "rtl" == d.lang.dir;
                        c[f ? 37 : 39] = "next";
                        c[40] = "next";
                        c[9] = "next";
                        ...
                        if (c) {
                            ...
                            if (b = a && a.getRanges()[0]) {
                                for (var a = new CKEDITOR.dom.walker(b), f = b.collapsed ? b.startContainer : a.next(), b = ""; f;) {
                                    ...
                                    b = b || f;
                                    if (b !== f) { b = ""; break } f = a.next()
                                }
                                a = b;
                                b = p._.getItems();
                                for (f = 0; f < b.count(); f++) { var g = b.getItem(f);
                ...
                var r = k.colorButton_colors.split(","),
                    ...
                    p = CKEDITOR.tools.addFunction(function(a, b) {
                        function c(a) {
                            ...
                            e.childRule = "back" == b ? function(a) { return v(a) } : function(a) { return !(a.is("a") || a.getElementsByTag("a").count()) || v(a) };
                            d.focus();
                        ...
                        d.focus();
                        d.fire("saveSnapshot");
                        if ("?" == a) d.getColorFromDialog(function(a) { if (a) return c(a) });
                        else return c(a)
                    });
            ...
            function u(a) { return CKEDITOR.tools.normalizeHex("#" + CKEDITOR.tools.convertRgbToHex(a || "")).replace(/#/g, "") }
            var k = d.config,
                h = d.lang.colorbutton;
            if (!CKEDITOR.env.hc) {
                t("TextColor", "fore", h.textColorTitle, 10, { contentTransformations: [
                ...
                if (void 0 === x || x) w.contentTransformations = [
                    [{ element: "span", left: function(a) { var d = CKEDITOR.tools; if ("span" != a.name || !a.styles || !a.styles.background) return !1;
                            a = d.style.parse.background(a.styles.background); return a.color && 1 === d.objectKeys(a).length }, right: function(a) { var e = (new CKEDITOR.style(d.config.colorButton_backStyle, { color: a.styles.background })).getDefinition();
                            a.name = e.element;
                            a.styles = e.styles;
    ...
    (function() {
        function p(b, f, e, d, r, p, v, x) {
            var y = b.config,
                ...
                g = r.split(";");
            r = [];
            for (var k = {}, l = 0; l < g.length; l++) { var m = g[l]; if (m) { var m = m.split("/"),
                        w = {},
                        q = g[l] = m[0];
                    w[e] = r[l] = m[1] || q;
                    k[q] = new CKEDITOR.style(v, w);
                    k[q]._.definition.name = q } else g.splice(l--, 1) } b.ui.addRichCombo(f, {
                label: d.label,
                title: d.panelTitle,
                toolbar: "styles," + x,
                ...
                contentTransformations: [
                    [{
                        ...
                        right: function(a) { var b = " x-small small medium large x-large xx-large 48px".split(" ");
                            a.name = "span";
                ...
                init: function() { var a;
                    ...
                    this.add(this.defaultValue, a, a); for (var c = 0; c < g.length; c++) a = g[c], this.add(a, k[a].buildPreview(), a) },
                onClick: function(a) {
                    b.focus();
                    b.fire("saveSnapshot");
                    var c = this.getValue(),
                        ...
                        if (e = k[c], c = b.getSelection().getRanges()[0], c.collapsed) {
                            if (n = b.elementPath(), h = n.contains(function(a) { return e.checkElementRemovable(a) })) {
                                ...
                                g = c.checkBoundaryOfElement(h,
                                    CKEDITOR.END);
                                if (d && g) { for (d = c.createBookmark(); n = h.getFirst();) n.insertBefore(h);
                                    h.remove();
                                    c.moveToBookmark(d) } else d || g ? c.moveToPosition(h, d ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_END) : (c.splitElement(h), c.moveToPosition(h, CKEDITOR.POSITION_AFTER_END)), u(c, n.elements.slice(), h);
                ...
                onRender: function() {
                    b.on("selectionChange", function(a) {
                        ...
                        for (var d = 0, f; d < a.length; d++) { f = a[d]; for (var e in k)
                                if (k[e].checkElementMatch(f, !0, b)) { e != c && this.setValue(e); return } } this.setValue("", p)
                    }, this)
                },
        ...
        function u(b, f, e) { var d = f.pop(); if (d) { if (e) return u(b, f, d.equals(e) ? null : e);
                e = d.clone();
                b.insertNode(e);
                b.moveToPosition(e, CKEDITOR.POSITION_AFTER_START);
                u(b, f) } } CKEDITOR.plugins.add("font", {
            requires: "richcombo",
            init: function(b) {
                var f = b.config;
    ...
    (function() {
        function q(a, c) { c = void 0 === c || c; var b; if (c) b = a.getComputedStyle("text-align");
        ...
        function h(a, c, b) {
            ...
            if (c) { switch (b) {
                ...
                this.requiredContent = f + "(" + this.cssClassName + ")" } else this.requiredContent = f + "{text-align}";
            this.allowedContent = {
                    ...
                    for (var f = c.createBookmarks(), d = c.getRanges(), e = this.cssClassName, h, g, k = a.config.useComputedState, k = void 0 === k || k, n = d.length - 1; 0 <= n; n--)
                        for (h = d[n].createIterator(), h.enlargeBr = b != CKEDITOR.ENTER_BR; g = h.getNextParagraph(b == CKEDITOR.ENTER_P ? "p" : "div");)
                            if (!g.isReadOnly()) {
                                ...
                                if ((l = a.activeFilter.check(l + "(" + e + ")")) || p) { g.removeAttribute("align");
                                    g.removeStyle("text-align"); var m = e && (g.$.className = CKEDITOR.tools.ltrim(g.$.className.replace(this.cssClassRegex, ""))),
        ...
        CKEDITOR.plugins.add("justify", {
            init: function(a) {
                if (!a.blockless) {
                    ...
                    a.ui.addButton && (a.ui.addButton("JustifyLeft", { label: a.lang.common.alignLeft, command: "justifyleft", toolbar: "align,10" }), a.ui.addButton("JustifyCenter", { label: a.lang.common.center, command: "justifycenter", toolbar: "align,20" }), a.ui.addButton("JustifyRight", {
                        label: a.lang.common.alignRight,
                        command: "justifyright",
                        toolbar: "align,30"
                    }), a.ui.addButton("JustifyBlock", { label: a.lang.common.justify, command: "justifyblock", toolbar: "align,40" }));
                    a.on("dirChanged", m)
                }
            }
        })
    ...
    CKEDITOR.config.plugins = 'basicstyles,dialogui,dialog,notification,button,toolbar,clipboard,panelbutton,panel,floatpanel,colorbutton,enterkey,entities,floatingspace,listblock,richcombo,font,format,indent,indentlist,justify,list,maximize,smiley,sourcearea,stylescombo,undo,lineutils,widgetselection,widget,wysiwygarea,fakeobjects';
    CKEDITOR.config.skin = 'moono-lisa';
    (function() { var setIcons = function(icons, strip) { var path = CKEDITOR.getUrl('plugins/' + strip);
            icons = icons.split(','); for (var i = 0; i < icons.length; i++) CKEDITOR.skin.icons[icons[i]] = { path: path, offset: -icons[++i], bgsize: icons[++i] }; }; if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,copy-rtl,144,,copy,168,,cut-rtl,192,,cut,216,,paste-rtl,240,,paste,264,,bgcolor,288,,textcolor,312,,indent-rtl,336,,indent,360,,outdent-rtl,384,,outdent,408,,justifyblock,432,,justifycenter,456,,justifyleft,480,,justifyright,504,,bulletedlist-rtl,528,,bulletedlist,552,,numberedlist-rtl,576,,numberedlist,600,,maximize,624,,smiley,648,,source-rtl,672,,source,696,,redo-rtl,720,,redo,744,,undo-rtl,768,,undo,792,', 'icons_hidpi.png');
        else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,copy-rtl,144,auto,copy,168,auto,cut-rtl,192,auto,cut,216,auto,paste-rtl,240,auto,paste,264,auto,bgcolor,288,auto,textcolor,312,auto,indent-rtl,336,auto,indent,360,auto,outdent-rtl,384,auto,outdent,408,auto,justifyblock,432,auto,justifycenter,456,auto,justifyleft,480,auto,justifyright,504,auto,bulletedlist-rtl,528,auto,bulletedlist,552,auto,numberedlist-rtl,576,auto,numberedlist,600,auto,maximize,624,auto,smiley,648,auto,source-rtl,672,auto,source,696,auto,redo-rtl,720,auto,redo,744,auto,undo-rtl,768,auto,undo,792,auto', 'icons.png'); })();
    CKEDITOR.lang.languages = { "en": 1, "zh-cn": 1 };
}());